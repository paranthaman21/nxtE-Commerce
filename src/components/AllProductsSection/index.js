...
class AllProductsSection extends Component {
  ...
  getProducts = async () => {
    ...
    const apiUrl = `https://apis.ccbp.in/products?sort_by=${activeOptionId}&category=${activeCategoryOption}&title_search=${searchInput}&rating=${activeRatingId}`
  ...
  changeCategoryby = activeCategoryOption => {
    this.setState({activeCategoryOption}, this.getProducts)
  }
  ...
  render() {
    const {apiStatus, searchInput, activeRatingId} = this.state
